...
def combine_results(
    ...
    """Combine the results from a function applied to a masked DataFrame back
...
def apply_vectorizer(
    ...
    **vectorizer_kwargs
    ...
    if vectorizer_name == "CountVectorizer":
        ...
        raise ValueError(
            "Unsupported vectorizer. Use 'CountVectorizer' or 'TfidfVectorizer'."
        )
